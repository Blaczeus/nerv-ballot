                        ...
                        <div class="col-lg-4">
                            <div class="footer-menu">
                                <div class="footer-col-block">
                                    <div
                                        class="footer-heading text-button footer-heading-mobile"
                                    >
                                        Infomation
                                    </div>
                                    ...
                                    <div class="footer-newsletter">
                                        ...
                                        <div class="tf-cart-checkbox">
                                            ...
                                            <label
                                                ...
                                                for="footer-Form_agree"
                                            >
                                                By clicking subcribe, you agree
                                                to the
                                                <a
                                                    class="fw-6 link"
                                                    href="term-of-use.html"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="footer-bottom-wrap">
                                <div class="left">
                                    <p class="text-caption-1">
                                        &copy;2024 Modave. All Rights Reserved.
                                    </p>
                                ...
                                <div class="tf-payment">
                                    ...
                                    <ul>
                                        <li>
                                            <img
                                                src="/tmp/images/payment/img-1.png"
                                                alt=""
                                            />
                                        </li>
                                        <li>
                                            <img
                                                src="/tmp/images/payment/img-2.png"
                                                alt=""
                                            />
                                        </li>
                                        <li>
                                            <img
                                                src="/tmp/images/payment/img-3.png"
                                                alt=""
                                            />
                                        </li>
                                        <li>
                                            <img
                                                src="/tmp/images/payment/img-4.png"
                                                alt=""
                                            />
                                        </li>
                                        <li>
                                            <img
                                                src="/tmp/images/payment/img-5.png"
                                                alt=""
                                            />
                                        </li>
                                        <li>
                                            <img
                                                src="/tmp/images/payment/img-6.png"
                                                alt=""
                                            />
                                        </li>
                                    </ul>
