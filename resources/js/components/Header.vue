...
<template>
    <div class="tf-topbar bg-main">
        <div class="container">
            <div
                class="tf-topbar_wrap d-flex align-items-center justify-content-center justify-content-xl-between"
            >
                <ul class="topbar-left">
                    <li>
                        <a
                            class="text-caption-1 text-white"
                            href="tel:315-666-6688"
                            >315-666-6688</a
                        >
                    </li>
                    <li>
                        <a class="text-caption-1 text-white" href="#"
                            >themesflat@gmail.com</a
                        >
                    </li>
                    <li>
                        <a
                            class="text-caption-1 text-decoration-underline text-white"
                    ...
                    <div class="tf-cur justify-content-end">
                        <div class="tf-currencies">
                            ...
                            >
                                <option
                                    selected
                                    data-thumbnail="/tmp/images/country/us.svg"
                                >
                                    USD
                                </option>
                                <option
                                    data-thumbnail="/tmp/images/country/vn.svg"
                                >
                                    VND
                                </option>
                            </select>
            ...
            <div class="row wrapper-header align-items-center">
                ...
                <div class="col-xl-6 d-none d-xl-block">
                    <nav class="box-navigation text-center">
                        <ul
                            class="box-nav-ul d-flex align-items-center justify-content-center"
                        >
                            <li
                                v-for="item in items"
                                :key="item.label"
                            ...
                            >
                                ...
                                <div
                                    v-if="item.children?.length"
                                    class="sub-menu submenu-default"
                                >
                                    <ul class="menu-list">
                                        <li
                ...
                <div class="col-xl-3 col-md-4 col-3">
                    <ul
                        class="nav-icon d-flex justify-content-end align-items-center"
                    >
                        <li class="nav-search">
                            <a
                                href="#search"
