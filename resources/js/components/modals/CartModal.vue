                    ...
                    <div class="wrap-recommendations">
                        <div class="list-cart">
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload"  :data-src="contestant?.image ?? '/tmp/images/products/womens/women-1.jpg'"   :src="contestant?.image ?? '/tmp/images/products/womens/women-1.jpg'"  alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                ...
                                <div class="tf-mini-cart-sroll">
                                    <div class="tf-mini-cart-items">
                                        ...
                                        <div class="tf-mini-cart-item file-delete">
                                            ...
                                            <div class="tf-mini-cart-info grow">
                                                <div class="mb_12 d-flex align-items-center justify-content-between flex-wrap gap-12">
                                                    <div class="text-title"><a :href="contestant ? `/contestants/${contestant.slug}` : 'product-detail.html'" class="link text-line-clamp-1">{{ contestant?.name ?? 'Suede leggings' }}</a></div>
                                                    <div class="text-button tf-btn-remove remove">Remove</div>
                                                </div>
                                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-12">
                                                    <div class="text-secondary-2">Number of Votes: 1</div>
