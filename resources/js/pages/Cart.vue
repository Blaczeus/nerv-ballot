                    ...
                    <div class="col-xl-8">
                        <div class="tf-cart-sold">
                            <div class="notification-sold bg-surface">
                                <img class="icon" src="/tmp/images/logo/icon-fire.png" alt="img">
                                ...
                                <tbody>
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            <a href="/contestants/john-doe" class="img-box">
                                                <img src="/tmp/images/products/womens/women-19.jpg" alt="product">
                                            </a>
                                            <div class="cart-info">
                                                <a href="/contestants/john-doe" class="cart-title link">V-neck cotton T-shirt</a>
                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            <a href="/contestants/john-doe" class="img-box">
                                                <img src="/tmp/images/products/womens/women-1.jpg" alt="product">
                                            </a>
                                            <div class="cart-info">
                                                <a href="/contestants/john-doe" class="cart-title link">V-neck cotton T-shirt</a>
                                                <div class="variant-box">
                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            <a href="/contestants/john-doe" class="img-box">
                                                <img src="/tmp/images/products/womens/women-29.jpg" alt="product">
                                            </a>
                                            <div class="cart-info">
                                                <a href="/contestants/john-doe" class="cart-title link">V-neck cotton T-shirt</a>
                                                <div class="variant-box">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0s">
                                <div class="card-product-wrapper">
                                    <a href="/contestants/john-doe" class="product-img">
                                ...
                                <div class="card-product-info">
                                    <a href="/contestants/john-doe" class="title link">V-neck cotton T-shirt</a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="card-product-info">
                                    <a href="/contestants/john-doe" class="title link">Polarized sunglasses</a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product card-product-size wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="card-product-info">
                                    <a href="/contestants/john-doe" class="title link">Ramie shirt with pockets </a>
                        ...
                        <div class="swiper-slide">
                            <div class="card-product wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <div class="card-product-info">
                                    <a href="/contestants/john-doe" class="title link">Ribbed cotton-blend top</a>
                                    ...
                                    <div class="tf-compare-list list-file-delete">
                                        ...
                                        <div class="tf-compare-wrap">
                                            <div class="tf-compare-item file-delete">
                                                ...
                                                <a href="/contestants/john-doe" class="image">
                                                    <img class="lazyload" data-src="/tmp/images/products/womens/women-19.jpg" src="/tmp/images/products/womens/women-19.jpg" alt="">
                                                </a>
                                                <div class="content">
                                                    <div class="text-title">
                                                        <a class="link text-line-clamp-2" href="/contestants/john-doe">V-neck cotton T-shirt</a>
                                                    </div>
                                            ...
                                            <div class="tf-compare-item file-delete">
                                                ...
                                                <div class="content">
                                                    <div class="text-title">
                                                        <a class="link text-line-clamp-2" href="/contestants/john-doe">Ramie shirt with pockets </a>
                                                    </div>
                                            ...
                                            <div class="tf-compare-item file-delete">
                                                ...
                                                <div class="content">
                                                    <div class="text-title">
                                                        <a class="link text-line-clamp-2" href="/contestants/john-doe">Ribbed cotton-blend top</a>
                                                    </div>
