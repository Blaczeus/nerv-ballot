                                    ...
                                    <div class="payment-box" id="payment-box">
                                        ...
                                        <div class="payment-item">
                                            <label for="apple-method" class="payment-header collapsed" data-bs-toggle="collapse" data-bs-target="#apple-payment" aria-controls="apple-payment">
                                                ...
                                                <span class="text-title apple-pay-title"><img src="/tmp/images/payment/applePay.png" alt="apple"> Apple Pay</span>
                                            </label>
                                        ...
                                        <div class="payment-item paypal-item">
                                            <label for="paypal-method" class="payment-header collapsed" data-bs-toggle="collapse" data-bs-target="#paypal-method-payment" aria-controls="paypal-method-payment">
                                                ...
                                                <span class="paypal-title"><img src="/tmp/images/payment/paypal.png" alt="apple"></span>
                                            </label>
                            ...
                            <div class="sidebar-checkout-content">
                                ...
                                <div class="list-product">
                                    <div class="item-product">
                                        <a href="/contestants/john-doe" class="img-product">
                                            <img src="/tmp/images/products/womens/women-19.jpg" alt="img-product">
                                        </a>
                                        <div class="content-box">
                                            <div class="info">
                                                <a href="/contestants/john-doe" class="name-product link text-title">V-neck cotton T-shirt</a>
                                    ...
                                    <div class="item-product">
                                        <a href="/contestants/john-doe" class="img-product">
                                            <img src="/tmp/images/products/womens/women-1.jpg" alt="img-product">
                                        </a>
                                        <div class="content-box">
                                            <div class="info">
                                                <a href="/contestants/john-doe" class="name-product link text-title">Polarized sunglasses</a>
                                                <div class="variant text-caption-1 text-secondary"><span class="size">XL</span>/<span class="color">Blue</span></div>
                                            </div>
                                            <div class="total-price text-button"><span class="count">1</span>X<span class="price">$60.00</span></div>
                                        </div>
                                    ...
                                    <div class="item-product">
                                        <a href="/contestants/john-doe" class="img-product">
                                            <img src="/tmp/images/products/womens/women-29.jpg" alt="img-product">
                                        </a>
                                        <div class="content-box">
                                            <div class="info">
                                                <a href="/contestants/john-doe" class="name-product link text-title">Ramie shirt with pockets </a>
                                                <div class="variant text-caption-1 text-secondary"><span class="size">XL</span>/<span class="color">Blue</span></div>
                                            </div>
                                            <div class="total-price text-button"><span class="count">1</span>X<span class="price">$60.00</span></div>
                                        </div>
